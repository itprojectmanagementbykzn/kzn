    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(child: Text(
          '''
          KZN Learning School values the privacy of every person and is committed to protecting information that schools collect.

School's all staff must comply with KZN Learning School School privacy law and policy.

This policy explains how our school collects and manages personal information, consistent with KZN Learning School law.'''
        )),
      ),

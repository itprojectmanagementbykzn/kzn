      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListTile(
              leading: Icon(Icons.privacy_tip, color: Colors.indigo[900],),
              title: Text('Privacy Policy', style: TextStyle(color: Colors.indigo[900])),
              onTap: () {
          ...
          Container(
            margin: EdgeInsets.all(8),
            child: ListTile(
              leading: Icon(Icons.book, color: Colors.indigo[900]),
              title: Text('Terms of Conditions', style: TextStyle(color: Colors.indigo[900])),
              onTap: () {
                // Update the state of the app
                // ...
                // Then close the drawer
          ...
          Container(
            ...
            child: ListTile(
              leading: Icon(Icons.group, color: Colors.indigo[900]),
              title: Text('About', style: TextStyle(color: Colors.indigo[900]),),
              onTap: () {
                // Update the state of the app
                // ...
                // Then close the drawer
          ...
          Container(
            ...
            child: ListTile(
              ...
              title: Text('Logout', style: TextStyle(color: Colors.indigo[900])),
              onTap: () {
                // Update the state of the app
                // ...
                // Then close the drawer
